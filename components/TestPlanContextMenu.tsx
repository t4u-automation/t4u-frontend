...
interface TestPlanContextMenuProps {
  testPlanName: string;
  onEdit?: () => void;
  onDelete?: () => void;
}

export default function TestPlanContextMenu({
  testPlanName,
  onEdit,
  onDelete,
}: TestPlanContextMenuProps) {
  ...
  return (
    <>
      ...
      <ConfirmDialog
        ...
        message={`Are you sure you want to delete "${testPlanName}"? This action cannot be undone.`}
        confirmText="Delete"
        cancelText="Cancel"
